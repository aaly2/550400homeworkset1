...
your own words.   \newline \newline
The first step to answer this question is to define what a tennis game. My model will be based on my perception of the rules of the tennis. I have to admit that I am not entirely clear on the details of the rules of tennis. My basic understanding is depicted in the diagram below figure \ref{fig:tennis}: \newline 
\begin{figure}[h]
    \begin{center}
